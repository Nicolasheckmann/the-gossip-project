...
ActiveRecord::Schema.define(version: 2021_05_10_151856) do
  ...
  create_table "gossip_tagings", force: :cascade do |t|
    t.bigint "gossip_id"
    t.bigint "tag_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["gossip_id"], name: "index_gossip_tagings_on_gossip_id"
    t.index ["tag_id"], name: "index_gossip_tagings_on_tag_id"
  end
